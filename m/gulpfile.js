(function () {
    ...
    gulp.task('styles-ios', function (cb) {
        var cbs = 0;
        ['framework7.ios.less', 'framework7.ios.namespace.less', 'framework7.ios.rtl.less', 'framework7.ios.colors.less'].forEach(function (lessFilePath, b) {
    ...
    gulp.task('demo-app', function (cb) {
        ...
        gulp.src(paths.source.root + 'my-app/app.js')
            .pipe(gulp.dest(paths.build.scripts));
        ...
        gulp.src([paths.build.root + '**/*.*'])
            ...
            .on('end', function () {
                ...
                var minifiedCSS = [
                    ...
                    paths.dist.styles + f7.filename + '.ios.namespace.css',
    ...
    gulp.task('move', function() {
        gulp.src('m/*').pipe(gulp.dest('/Users/SHARON/sharon/abcxo/study/project/m/tomato/www/'));
        gulp.src('m/css/*').pipe(gulp.dest('/Users/SHARON/sharon/abcxo/study/project/m/tomato/www/css/'));
        gulp.src('m/img/*').pipe(gulp.dest('/Users/SHARON/sharon/abcxo/study/project/m/tomato/www/img/'));
        return gulp.src('m/js/*').pipe(gulp.dest('/Users/SHARON/sharon/abcxo/study/project/m/tomato/www/js/'));
    });
    ...
    gulp.task('default', ['build', 'dist','move']);
